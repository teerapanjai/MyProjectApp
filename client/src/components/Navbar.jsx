...
const Navbar = () => {
  ...
  return (
    <header className="w-full bg-transparent bg-teal-500 fixed top-0 left-0 right-0 transition-all ease-in duration-300">
      <nav
        className={`py-4 lg:px-24 px-4 bg-teal-500 ${
          isSticky ? "sticky top-0 left-0 right-0 bg-teal-400" : ""
        }`}
      >
